class symfony2::php-setup {
  $php = ["php5-fpm", "php5-cli", "php5-dev", "php5-gd", "php5-curl", "php5-mcrypt", "php5-xdebug", "php5-sqlite", "php5-mysql", "php5-memcache", "php5-intl", "php5-ldap", "php5-imap", "php5-imagick"]
  ...
  #   ensure => file,
  #   mode   => 644,
  #   source => 'puppet:///modules/symfony2/php/fpm/pool.d/www.conf',
  #   require => Package[$php],
  # }
